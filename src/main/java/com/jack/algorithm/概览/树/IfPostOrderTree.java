...
public class IfPostOrderTree {
    ...
    private boolean isPostArray(int [] array) {
    ...
    public static void main(String[] args) {
        IfPostOrderTree ifPostOrderTree = new IfPostOrderTree();
        int [] arr = {1,2,3,4,5,6,7};
        System.out.println(ifPostOrderTree.isPostArray(arr));
    }
}